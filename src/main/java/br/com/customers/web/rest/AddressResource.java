...
/**
 * REST controller for managing {@link br.com.customers.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AddressResource {
    ...
    /**
     * {@code GET  addresses/{id}/addresses} : get the "id" client.
     *
    ...
    public List<AddressDTO> findAddressesByClientId(@PathVariable Long id) {
        log.debug("REST request to get Addresses : {}", id);
        return addressService.findAddressesByClientId(id);
    }
}
